...
function SetupView({
  ...
  return (
    <div className={PANEL}>
      <div className={PANEL_HEADER}>Gmail 연결</div>
      <div className="flex flex-col gap-3 p-4 text-[15px]">
        <p className="text-[13px] text-muted-foreground">
          받은편지함·보낸편지함을 보려면 Google Cloud 데스크톱 앱 OAuth
          클라이언트가 필요합니다.
        </p>
        <ol className="flex list-decimal flex-col gap-2 pl-5 text-muted-foreground">
          ...
          <li>
            ...
            에서 <b className="text-foreground">Gmail API</b> 사용 설정
          </li>
          <li>
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="gmail-id">클라이언트 ID</Label>
          <Input
            id="gmail-id"
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="gmail-secret">클라이언트 보안 비밀</Label>
          <Input
            id="gmail-secret"
            type="password"
            placeholder="GOCSPX-..."
